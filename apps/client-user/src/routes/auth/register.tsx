...
import { AlertCircle, ArrowRight, AtSign, Lock, Mail, User, Zap } from "lucide-react";
...
const styles = stylex.create({
	...
	submitButton: {
		...
		":hover": {
			...
			backgroundImage: `linear-gradient(135deg, ${colors.purple600}, ${colors.indigo600})`,
		},
		":active": {
		...
		<div {...stylex.props(styles.wrapper)}>
			...
			<div {...stylex.props(styles.brandingSide)}>
				...
				<div {...stylex.props(styles.brandingContent)}>
					...
					<h1 {...stylex.props(styles.brandingTitle)}>Join Vaye</h1>
