...
import { Bookmark, Compass, Home, LogOut, MessageSquare, Search, Zap } from "lucide-react";
				...
				<div {...stylex.props(styles.inner)}>
					...
					<Link to="/" {...stylex.props(styles.logoLink)}>
						<div {...stylex.props(styles.logoIcon, styles.logoIconHover)}>
							<Zap {...stylex.props(styles.iconWhite)} size={20} />
						</div>
						<span {...stylex.props(styles.logoText)}>Vaye</span>
					</Link>

					{/* Navigation - hidden on mobile, using MobileNav bottom bar instead */}
					<nav {...stylex.props(styles.nav, styles.navDesktopOnly)}>
